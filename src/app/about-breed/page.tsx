...
const sections = [
  {
    title: "Overview",
    body: `Our puppies are a carefully planned cross — one-quarter Border Collie and three-quarters Goldendoodle, which means each pup carries roughly one-quarter Border Collie, three-eighths Golden Retriever, and three-eighths Poodle. This three-breed foundation brings together exceptional intelligence, gentle warmth, and a low-shedding coat in one versatile companion. The Border Collie contributes sharp focus and trainability, the Golden Retriever adds patience and an easygoing nature, and the Poodle rounds things out with hypoallergenic qualities and keen problem-solving ability. The result is a dog that is brilliant but not intense, active but not restless, and deeply devoted to its family.`,
  },
  {
    title: "Temperament",
    body: `With the Border Collie ranked first in breed intelligence, the Poodle second, and the Golden Retriever fourth, these dogs inherit an extraordinary capacity to learn. But what truly sets them apart is how that intelligence is delivered — wrapped in warmth and a genuine desire to please. The Golden Retriever influence softens the Border Collie's intensity, producing a dog that is affectionate, patient, and gentle with children, strangers, and other pets alike. They bond deeply with their families and are happiest when they're part of the action, whether that's a training session in the yard or a quiet evening at home. They may show a mild herding instinct from the Border Collie side — the occasional nudge or circle — but it's easily redirected and often endearing.`,
  },
  {
    title: "Size & Appearance",
    body: `Our dogs mature to a medium size, typically weighing between 35 and 55 pounds — males tend toward the higher end at 45 to 55 pounds, while females settle around 35 to 45 pounds. They stand 18 to 23 inches at the shoulder with a slightly sturdier build than a standard Bordoodle, thanks to the Golden Retriever influence. Coats range from wavy and loose-curled (the most common) to curly or occasionally straight, and you'll find a beautiful variety of colors in our lines — cream, gold, apricot, red, chocolate, black and white, blue merle, tricolor, sable, and parti patterns. The Golden Retriever heritage means golden, cream, and apricot tones appear especially often.`,
  },
  {
  ...
  {
    title: "Coat & Grooming",
    body: `One of the great advantages of this cross is a low to minimal shedding coat — curlier coats shed less, and while no dog is guaranteed hypoallergenic, most of our puppies are allergy-friendly. Their hair grows continuously, so regular grooming is essential. Plan on brushing two to three times per week at minimum (daily for curlier coats) and professional grooming every six to eight weeks. Pay special attention to areas prone to matting — behind the ears, in the armpits, and around the collar. Because their floppy ears can trap moisture, regular ear cleaning is also important to prevent infections.`,
  },
  {
